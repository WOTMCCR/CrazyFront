<template>
  <view class="flex-col section_3" :style="{ background: color }">
    ...
    <view>
        ...
        <uni-easyinput v-model="name" placeholder="请输入标题" > </uni-easyinput>
		<span class="self-start font title">时间</span>
		<uni-easyinput v-model="time" placeholder="请输入时间"></uni-easyinput>
        <span class="self-start font title">地点</span>
        <uni-easyinput v-model="address" placeholder="请输入地点"></uni-easyinput>
        <span class="self-start font title">联系方式</span>
        <uni-easyinput v-model="contact" placeholder="请输入负责人联系方式" ></uni-easyinput>
        <span class="self-start font title">介绍</span>
        <uni-easyinput v-model="content" placeholder="请输入活动内容、主题等" ></uni-easyinput>
...
<style scoped lang="scss">
	...
	.text-wrapper {
	    ...
	    overflow: hidden;
	    margin: 35rpx auto;
	    box-shadow: 3px 3px 1px 1px grey; /* 添加了右下方的阴影 */
	}
